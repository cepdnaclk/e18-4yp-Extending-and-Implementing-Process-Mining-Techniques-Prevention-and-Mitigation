...
package com.processdataquality.praeclarus.suggestions;
 ...
 * @date 9/6/21
 */
public abstract class AbstractSuggestions extends AbstractPlugin implements Suggestions {

    protected Destination _destination;

    protected AbstractSuggestions() {
